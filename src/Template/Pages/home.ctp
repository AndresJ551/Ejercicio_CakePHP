...
<div class="row">
    <div class="columns large-12">
		<h5>Se mantuvo este archivo para realizar las validaciones de los requerimientos de CakePHP,<br>
		el ejercicio 1.b se encuentra en <a href="turbinas">/cake/turbinas</a>.</h5>
    </div>
    <hr />
</div>
